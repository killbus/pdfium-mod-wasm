...
###############################################################################
# Apply patches on every run (just like dev.sh)
###############################################################################
