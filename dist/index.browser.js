var createPdfium = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    (Module['_EPDFAnnot_SetBorderDashPattern'] =
    ...
    (Module['_EPDFAnnot_SetDefaultAppearance'] =
      createExportWrapper('EPDFAnnot_SetDefaultAppearance', 6));
    (Module['_EPDFAnnot_GetDefaultAppearance'] =
    ...
    (Module['_EPDFAnnot_SetVerticalAlignment'] =
      createExportWrapper('EPDFAnnot_SetVerticalAlignment', 2));
    (Module['_EPDFAnnot_GetVerticalAlignment'] =
    ...
    (Module['_EPDFAnnot_UpdateAppearanceToRect'] =
