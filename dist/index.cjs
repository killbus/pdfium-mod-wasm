...
function requirePdfium () {
	...
	(function (module, exports$1) {
		...
		Module['_FPDF_ImportBookmarks'] = createExportWrapper('FPDF_ImportBookmarks', 5);
...
const functions = {
    ...
    FPDF_ImportBookmarks: [["number", "number", "number", "number", "number"], 'boolean'],
