...
function requirePdfium () {
	...
	(function (module, exports$1) {
		...
		Module['_EPDFBookmark_GetColor'] = createExportWrapper('EPDFBookmark_GetColor', 4);
		Module['_EPDFBookmark_SetColor'] = createExportWrapper('EPDFBookmark_SetColor', 4);
		Module['_EPDFBookmark_GetFlags'] = createExportWrapper('EPDFBookmark_GetFlags', 1);
		Module['_EPDFBookmark_SetFlags'] = createExportWrapper('EPDFBookmark_SetFlags', 2);
		Module['_EPDFBookmark_SetCount'] = createExportWrapper('EPDFBookmark_SetCount', 2);
		Module['_EPDF_PNG_EncodeRGBA'] = createExportWrapper('EPDF_PNG_EncodeRGBA', 6);
		Module['_FPDF_CopyBookmarks'] = createExportWrapper('FPDF_CopyBookmarks', 4);
		Module['_FPDF_RemapPageLinks'] = createExportWrapper('FPDF_RemapPageLinks', 4);
		Module['_FPDF_UpdateBookmarkDestinations'] = createExportWrapper('FPDF_UpdateBookmarkDestinations', 4);
		Module['_FPDF_GetRoot'] = createExportWrapper('FPDF_GetRoot', 1);
		Module['_FPDF_GetTrailer'] = createExportWrapper('FPDF_GetTrailer', 1);
		Module['_FPDF_GetInfoDict'] = createExportWrapper('FPDF_GetInfoDict', 1);
		Module['_FPDF_NewIndirectDict'] = createExportWrapper('FPDF_NewIndirectDict', 1);
		Module['_FPDF_NewIndirectArray'] = createExportWrapper('FPDF_NewIndirectArray', 1);
		Module['_FPDF_NewDict'] = createExportWrapper('FPDF_NewDict', 1);
		Module['_FPDF_NewArray'] = createExportWrapper('FPDF_NewArray', 1);
		Module['_FPDF_NewString'] = createExportWrapper('FPDF_NewString', 2);
		Module['_FPDF_NewName'] = createExportWrapper('FPDF_NewName', 2);
		Module['_FPDF_NewBoolean'] = createExportWrapper('FPDF_NewBoolean', 2);
		Module['_FPDF_NewNumber'] = createExportWrapper('FPDF_NewNumber', 2);
		Module['_FPDF_NewReference'] = createExportWrapper('FPDF_NewReference', 2);
		Module['_FPDF_Dict_Get'] = createExportWrapper('FPDF_Dict_Get', 2);
		Module['_FPDF_Dict_Set'] = createExportWrapper('FPDF_Dict_Set', 3);
		Module['_FPDF_Dict_SetString'] = createExportWrapper('FPDF_Dict_SetString', 3);
		Module['_FPDF_Dict_Remove'] = createExportWrapper('FPDF_Dict_Remove', 2);
		Module['_FPDF_Array_Count'] = createExportWrapper('FPDF_Array_Count', 1);
		Module['_FPDF_Array_Get'] = createExportWrapper('FPDF_Array_Get', 2);
		Module['_FPDF_Array_Add'] = createExportWrapper('FPDF_Array_Add', 2);
		Module['_FPDF_Stream_GetData'] = createExportWrapper('FPDF_Stream_GetData', 4);
		...
		Module['_EPDFAnnot_SetNameValue'] = createExportWrapper('EPDFAnnot_SetNameValue', 3);
		Module['_EPDFAnnot_SetIntArrayValue'] = createExportWrapper('EPDFAnnot_SetIntArrayValue', 4);
		Module['_EPDFPage_RemoveAnnotRaw'] = createExportWrapper('EPDFPage_RemoveAnnotRaw', 3);
		Module['_EPDFAnnot_SetIcon'] = createExportWrapper('EPDFAnnot_SetIcon', 2);
		Module['_EPDFAnnot_GetIcon'] = createExportWrapper('EPDFAnnot_GetIcon', 1);
		Module['_EPDFAnnot_UpdateAppearanceToRect'] = createExportWrapper('EPDFAnnot_UpdateAppearanceToRect', 2);
		Module['_EPDFDoc_CreateIndirectDict'] = createExportWrapper('EPDFDoc_CreateIndirectDict', 1);
		Module['_EPDFPage_CreateAnnot'] = createExportWrapper('EPDFPage_CreateAnnot', 2);
		Module['_EPDFAnnot_SetHexBinaryValue'] = createExportWrapper('EPDFAnnot_SetHexBinaryValue', 4);
		...
		Module['_EPDFDoc_RegisterSignatureWidget'] = createExportWrapper('EPDFDoc_RegisterSignatureWidget', 2);
		...
		Module['_FPDFImageObj_LoadJpegBuffer'] = createExportWrapper('FPDFImageObj_LoadJpegBuffer', 5);
		...
		Module['_FPDFImageObj_SetImageData'] = createExportWrapper('FPDFImageObj_SetImageData', 2);
		...
		Module['_FPDF_ClonePage'] = createExportWrapper('FPDF_ClonePage', 3);
		Module['_FPDF_CopyViewerPreferences'] = createExportWrapper('FPDF_CopyViewerPreferences', 2);
		Module['_FPDF_PageImport_Begin'] = createExportWrapper('FPDF_PageImport_Begin', 2);
		Module['_FPDF_PageImport_ImportPages'] = createExportWrapper('FPDF_PageImport_ImportPages', 4);
		Module['_FPDF_PageImport_End'] = createExportWrapper('FPDF_PageImport_End', 1);
		Module['_FPDF_XObject_BeginSession'] = createExportWrapper('FPDF_XObject_BeginSession', 2);
		Module['_FPDF_XObject_CreateFromPage'] = createExportWrapper('FPDF_XObject_CreateFromPage', 2);
		Module['_FPDF_XObject_EndSession'] = createExportWrapper('FPDF_XObject_EndSession', 1);
		...
		Module['_FPDF_CreateSaveSession'] = createExportWrapper('FPDF_CreateSaveSession', 4);
		Module['_FPDF_CreateIncrementalSaveSession'] = createExportWrapper('FPDF_CreateIncrementalSaveSession', 6);
		Module['_FPDF_SaveNextChunk'] = createExportWrapper('FPDF_SaveNextChunk', 1);
		Module['_FPDF_GetSaveProgress'] = createExportWrapper('FPDF_GetSaveProgress', 1);
		Module['_FPDF_DestroySaveSession'] = createExportWrapper('FPDF_DestroySaveSession', 1);
...
const functions = {
    ...
    EPDFAnnot_SetHexBinaryValue: [["number", "string", "number", "number"], 'boolean'],
    EPDFAnnot_SetIcon: [["number", "number"], 'boolean'],
    EPDFAnnot_SetIntArrayValue: [["number", "string", "number", "number"], 'boolean'],
    ...
    EPDFAnnot_SetNameValue: [["number", "string", "string"], 'boolean'],
    ...
    EPDFBookmark_GetColor: [["number", "number", "number", "number"], 'boolean'],
    EPDFBookmark_GetFlags: [["number"], 'number'],
    EPDFBookmark_InsertAfter: [["number", "number", "number", "number"], 'number'],
    EPDFBookmark_SetAction: [["number", "number", "number"], 'boolean'],
    EPDFBookmark_SetColor: [["number", "number", "number", "number"], 'boolean'],
    EPDFBookmark_SetCount: [["number", "number"], 'boolean'],
    EPDFBookmark_SetDest: [["number", "number", "number"], 'boolean'],
    EPDFBookmark_SetFlags: [["number", "number"], 'boolean'],
    ...
    EPDFDoc_CreateIndirectDict: [["number"], 'number'],
    EPDFDoc_RegisterSignatureWidget: [["number", "number"], 'boolean'],
    ...
    FPDF_Array_Add: [["number", "number"], 'boolean'],
    FPDF_Array_Count: [["number"], 'number'],
    FPDF_Array_Get: [["number", "number"], 'number'],
    FPDF_ClonePage: [["number", "number", "number"], 'boolean'],
    FPDF_CloseDocument: [["number"], null],
    FPDF_ClosePage: [["number"], null],
    FPDF_CloseXObject: [["number"], null],
    FPDF_CopyBookmarks: [["number", "number", "string", "number"], 'boolean'],
    ...
    FPDF_CreateIncrementalSaveSession: [["number", "number", "number", "number", "number"], 'number'],
    FPDF_CreateNewDocument: [[], 'number'],
    FPDF_CreateSaveSession: [["number", "number", "number", "number"], 'number'],
    FPDF_DestroyClipPath: [["number"], null],
    FPDF_DestroyLibrary: [[], null],
    FPDF_DestroySaveSession: [["number"], null],
    FPDF_DeviceToPage: [["number", "number", "number", "number", "number", "number", "number", "number", "number", "number"], 'boolean'],
    FPDF_Dict_Get: [["number", "string"], 'number'],
    FPDF_Dict_Remove: [["number", "string"], 'boolean'],
    FPDF_Dict_Set: [["number", "string", "number"], 'boolean'],
    FPDF_Dict_SetString: [["number", "string", "number"], 'boolean'],
    ...
    FPDF_GetInfoDict: [["number"], 'number'],
    ...
    FPDF_GetRoot: [["number"], 'number'],
    FPDF_GetSaveProgress: [["number"], 'number'],
    ...
    FPDF_NewArray: [["number"], 'number'],
    FPDF_NewBoolean: [["number", "boolean"], 'number'],
    FPDF_NewDict: [["number"], 'number'],
    FPDF_NewFormObjectFromXObject: [["number"], 'number'],
    FPDF_NewIndirectArray: [["number"], 'number'],
    FPDF_NewIndirectDict: [["number"], 'number'],
    FPDF_NewName: [["number", "string"], 'number'],
    FPDF_NewNumber: [["number", "number"], 'number'],
    FPDF_NewReference: [["number", "number"], 'number'],
    FPDF_NewString: [["number", "number"], 'number'],
    FPDF_NewXObjectFromPage: [["number", "number", "number"], 'number'],
    FPDF_PageImport_Begin: [["number", "number"], 'number'],
    FPDF_PageImport_End: [["number"], null],
    FPDF_PageImport_ImportPages: [["number", "number", "string", "number"], 'boolean'],
    FPDF_PageToDevice: [["number", "number", "number", "number", "number", "number", "number", "number", "number", "number"], 'boolean'],
    FPDF_RemapPageLinks: [["number", "number", "string", "number"], 'boolean'],
    ...
    FPDF_SaveNextChunk: [["number"], 'number'],
    ...
    FPDF_Stream_GetData: [["number", "number", "number", "number"], 'boolean'],
    ...
    FPDF_UpdateBookmarkDestinations: [["number", "number", "number", "number"], 'boolean'],
    ...
    FPDF_XObject_BeginSession: [["number", "number"], 'number'],
    FPDF_XObject_CreateFromPage: [["number", "number"], 'number'],
    FPDF_XObject_EndSession: [["number"], null],
    ...
    FPDFImageObj_LoadJpegBuffer: [["number", "number", "number", "number", "number"], 'boolean'],
    ...
    FPDFImageObj_SetImageData: [["number", "number"], 'boolean'],
...
const DEFAULT_PDFIUM_WASM_URL = 'https://cdn.jsdelivr.net/npm/@embedpdf/pdfium@1.0.0/dist/pdfium.wasm';
...
exports.DEFAULT_PDFIUM_WASM_URL = DEFAULT_PDFIUM_WASM_URL;
exports.init = init;
